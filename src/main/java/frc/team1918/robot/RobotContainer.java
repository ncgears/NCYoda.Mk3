...
public class RobotContainer {
  ...
  // private JoystickButton btn_ALLUP = new JoystickButton(dj, Constants.OI.Driver.BTN_ALLUP);
  // private JoystickButton btn_ANTIGRAV = new JoystickButton(dj, Constants.OI.Driver.BTN_ANTIGRAV);
