...
public class Constants {
    ...
    public static final class OI {
        ...
        public static final class Driver {
            ...
            public final static int BTN_ALLUP = Logitech.BTN_A; //Move collector to Up position
            public final static int BTN_ANTIGRAV = Logitech.BTN_B; //Engage anti-backdrive for climber
